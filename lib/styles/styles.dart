...
Color buttonColor = const Color(0xE450C5F8);
Color theme = const Color(0xE450C5F8);
Color buttonText = const Color(0xffFFFFFF);
Color inputFieldSeparator = const Color(0xE450C5F8);
Color termsCheckBox = const Color(0xff39BF4E);
Color loaderColor = const Color(0xE450C5F8);
Color notUploadedColor = Colors.orange;
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xE450C5F8);
...
Color starColor = const Color(0xE450C5F8);
...
Color buttonTextColorDarkMood = const Color(0xE450C5F8);
Color buttonTextColorLightMood = const Color(0xE450C5F8);
Color buttonColorDarkMood = const Color(0xffF8F8F8);
